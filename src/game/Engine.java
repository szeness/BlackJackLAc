...
public class Engine extends Gui {
    ...
    static boolean xOffdueSplitt = false;
    static boolean split2Turn = false;
    static boolean splitBool = false;
    static int karteSplit1;
    static int karteSplit2;
    ...
    static boolean doubleDownb = false;
    public static int karte1;
    public static int karte2;
    static boolean passedDealer = false;
    static boolean newGame21 = false;
    ...
    public static void passToDealer() throws InterruptedException {
        ...
        if (!newGBool && !xOffdueSplitt &&!passedDealer) {
            ...
            if (karte2 == 1) {karte2 = 11;Karten.asseCounter++;}


            kartenSumDealer = karte1 + karte2;

            if (karte1 == 11 && karte2 == 11) {
                kartenSumDealer = 21;
            }
            if (karte1 == 10 && karte2 == 10) {
                kartenSumDealer = 21;
            }
    ...
    public static void newGame() throws InterruptedException {
        ...
        Bet.setBet(50);
        Credit.setCredit(Credit.credit - Bet.getBet());
        Bet.checkBetz();
        ...
        if (karte1 == 11 && karte2 == 11) kartenSumSpieler = 21;
        if (karte1 == 10 && karte2 == 10) kartenSumSpieler = 21;
...
//////////////////////////// 2ND SPLIT ////////////////////////
                    ...
                    for (int i = 1; i < CardFramez.cardsPlayerArray.size(); i++) {
                        CardFramez.cardsPlayerArray.get(i).setVisible(true);
